...
class AppColorsResolved {
  ...
  factory AppColorsResolved.dark() => const AppColorsResolved._(
    ...
    purpleHoliday: AppColors.purpleHoliday,
    blueAttendance: AppColors.blueAttendance,
    presentText: AppColors._darkMonthSummaryPresentText,
    presentBg: AppColors._darkMonthSummaryPresentBg,
    holidayText: AppColors._darkMonthSummaryHolidayText,
    holidayBg: AppColors._darkMonthSummaryHolidayBg,
    leaveText: AppColors._darkMonthSummaryLeaveText,
    leaveBg: AppColors._darkMonthSummaryLeaveBg,
    absentText: AppColors._darkMonthSummaryAbsentText,
    absentBg: AppColors._darkMonthSummaryAbsentBg,
    weekendText: AppColors.weekendText,
