...
@override final  String? errorMessage;
 final  List<OverlapLeaveEntity> _overlapLeaves;
@override@JsonKey() List<OverlapLeaveEntity> get overlapLeaves {
  if (_overlapLeaves is EqualUnmodifiableListView) return _overlapLeaves;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_overlapLeaves);
}
