...
@override
int get hashCode => Object.hashAll([runtimeType,name,employee,employeeName,leaveType,fromDate,toDate,status,leaveApprover,docstatus,leaveApproverName,totalLeaveDays,halfDay,halfDayDate,description,isMyLeave,isApprover,showEditDelete,showCancel,showApprovalActions]);

@override
String toString() {
  return 'LeaveEntity(name: $name, employee: $employee, employeeName: $employeeName, leaveType: $leaveType, fromDate: $fromDate, toDate: $toDate, status: $status, leaveApprover: $leaveApprover, docstatus: $docstatus, leaveApproverName: $leaveApproverName, totalLeaveDays: $totalLeaveDays, halfDay: $halfDay, halfDayDate: $halfDayDate, description: $description, isMyLeave: $isMyLeave, isApprover: $isApprover, showEditDelete: $showEditDelete, showCancel: $showCancel, showApprovalActions: $showApprovalActions)';
}
