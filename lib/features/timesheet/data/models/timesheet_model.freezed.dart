...
mixin _$TimesheetModel {
 ...
 String get name; dynamic get employee;// Can be String ID or Map object
@JsonKey(name: 'employee_name') String? get employeeName;@JsonKey(name: 'hours_total') double get hoursTotal;@JsonKey(name: 'from_date') String? get fromDate;@JsonKey(name: 'to_date') String? get toDate; int get docstatus;@JsonKey(name: 'expected_hours') double get expectedHoursTotal;@JsonKey(name: 'remaining_hours') double get remainingHours;@JsonKey(name: 'actual_hours') double get totalSpentHours; String? get approver;@JsonKey(name: 'approver_name') String? get approverName;@JsonKey(name: 'organization_department') String? get department;@JsonKey(name: 'rows') List<ProjectAssignmentModel>? get projectAssignments;
...
@useResult
$Res call({
 String name, dynamic employee,@JsonKey(name: 'employee_name') String? employeeName,@JsonKey(name: 'hours_total') double hoursTotal,@JsonKey(name: 'from_date') String? fromDate,@JsonKey(name: 'to_date') String? toDate, int docstatus,@JsonKey(name: 'expected_hours') double expectedHoursTotal,@JsonKey(name: 'remaining_hours') double remainingHours,@JsonKey(name: 'actual_hours') double totalSpentHours, String? approver,@JsonKey(name: 'approver_name') String? approverName,@JsonKey(name: 'organization_department') String? department,@JsonKey(name: 'rows') List<ProjectAssignmentModel>? projectAssignments
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  dynamic employee, @JsonKey(name: 'employee_name')  String? employeeName, @JsonKey(name: 'hours_total')  double hoursTotal, @JsonKey(name: 'from_date')  String? fromDate, @JsonKey(name: 'to_date')  String? toDate,  int docstatus, @JsonKey(name: 'expected_hours')  double expectedHoursTotal, @JsonKey(name: 'remaining_hours')  double remainingHours, @JsonKey(name: 'actual_hours')  double totalSpentHours,  String? approver, @JsonKey(name: 'approver_name')  String? approverName, @JsonKey(name: 'organization_department')  String? department, @JsonKey(name: 'rows')  List<ProjectAssignmentModel>? projectAssignments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimesheetModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  dynamic employee, @JsonKey(name: 'employee_name')  String? employeeName, @JsonKey(name: 'hours_total')  double hoursTotal, @JsonKey(name: 'from_date')  String? fromDate, @JsonKey(name: 'to_date')  String? toDate,  int docstatus, @JsonKey(name: 'expected_hours')  double expectedHoursTotal, @JsonKey(name: 'remaining_hours')  double remainingHours, @JsonKey(name: 'actual_hours')  double totalSpentHours,  String? approver, @JsonKey(name: 'approver_name')  String? approverName, @JsonKey(name: 'organization_department')  String? department, @JsonKey(name: 'rows')  List<ProjectAssignmentModel>? projectAssignments)  $default,) {final _that = this;
switch (_that) {
case _TimesheetModel():
return $default(_that.name,_that.employee,_that.employeeName,_that.hoursTotal,_that.fromDate,_that.toDate,_that.docstatus,_that.expectedHoursTotal,_that.remainingHours,_that.totalSpentHours,_that.approver,_that.approverName,_that.department,_that.projectAssignments);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  dynamic employee, @JsonKey(name: 'employee_name')  String? employeeName, @JsonKey(name: 'hours_total')  double hoursTotal, @JsonKey(name: 'from_date')  String? fromDate, @JsonKey(name: 'to_date')  String? toDate,  int docstatus, @JsonKey(name: 'expected_hours')  double expectedHoursTotal, @JsonKey(name: 'remaining_hours')  double remainingHours, @JsonKey(name: 'actual_hours')  double totalSpentHours,  String? approver, @JsonKey(name: 'approver_name')  String? approverName, @JsonKey(name: 'organization_department')  String? department, @JsonKey(name: 'rows')  List<ProjectAssignmentModel>? projectAssignments)?  $default,) {final _that = this;
switch (_that) {
case _TimesheetModel() when $default != null:
return $default(_that.name,_that.employee,_that.employeeName,_that.hoursTotal,_that.fromDate,_that.toDate,_that.docstatus,_that.expectedHoursTotal,_that.remainingHours,_that.totalSpentHours,_that.approver,_that.approverName,_that.department,_that.projectAssignments);case _:
  return null;
...
class _TimesheetModel extends TimesheetModel {
  const _TimesheetModel({required this.name, required this.employee, @JsonKey(name: 'employee_name') this.employeeName, @JsonKey(name: 'hours_total') this.hoursTotal = 0.0, @JsonKey(name: 'from_date') this.fromDate, @JsonKey(name: 'to_date') this.toDate, this.docstatus = 0, @JsonKey(name: 'expected_hours') this.expectedHoursTotal = 0.0, @JsonKey(name: 'remaining_hours') this.remainingHours = 0.0, @JsonKey(name: 'actual_hours') this.totalSpentHours = 0.0, this.approver, @JsonKey(name: 'approver_name') this.approverName, @JsonKey(name: 'organization_department') this.department, @JsonKey(name: 'rows') final  List<ProjectAssignmentModel>? projectAssignments}): _projectAssignments = projectAssignments,super._();
  factory _TimesheetModel.fromJson(Map<String, dynamic> json) => _$TimesheetModelFromJson(json);

@override final  String name;
@override final  dynamic employee;
// Can be String ID or Map object
...
@override@JsonKey(name: 'expected_hours') final  double expectedHoursTotal;
@override@JsonKey(name: 'remaining_hours') final  double remainingHours;
@override@JsonKey(name: 'actual_hours') final  double totalSpentHours;
...
@override@JsonKey(name: 'rows') List<ProjectAssignmentModel>? get projectAssignments {
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,const DeepCollectionEquality().hash(employee),employeeName,hoursTotal,fromDate,toDate,docstatus,expectedHoursTotal,remainingHours,totalSpentHours,approver,approverName,department,const DeepCollectionEquality().hash(_projectAssignments));
...
/// Create a copy of TimesheetModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? employee = freezed,Object? employeeName = freezed,Object? hoursTotal = null,Object? fromDate = freezed,Object? toDate = freezed,Object? docstatus = null,Object? expectedHoursTotal = null,Object? remainingHours = null,Object? totalSpentHours = null,Object? approver = freezed,Object? approverName = freezed,Object? department = freezed,Object? projectAssignments = freezed,}) {
