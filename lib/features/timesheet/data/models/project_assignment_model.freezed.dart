...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,project,date,taskName,expectedHours,spentHours,description,hoursDetails,raisedBy,completed,approved,applicableForCompensatoryOff,status);

@override
String toString() {
  return 'ProjectAssignmentModel(name: $name, project: $project, date: $date, taskName: $taskName, expectedHours: $expectedHours, spentHours: $spentHours, description: $description, hoursDetails: $hoursDetails, raisedBy: $raisedBy, completed: $completed, approved: $approved, applicableForCompensatoryOff: $applicableForCompensatoryOff, status: $status)';
}
...
switch (_that) {
case _ProjectAssignmentModel() when $default != null:
return $default(_that.name,_that.project,_that.date,_that.taskName,_that.expectedHours,_that.spentHours,_that.description,_that.hoursDetails,_that.raisedBy,_that.completed,_that.approved,_that.applicableForCompensatoryOff,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? name,  String project,  String? date, @JsonKey(name: 'task_name')  String? taskName, @JsonKey(name: 'expected_hours')  double expectedHours, @JsonKey(name: 'spent_hours')  double spentHours,  String? description, @JsonKey(name: 'hours_details')  String? hoursDetails, @JsonKey(name: 'raised_by')  String? raisedBy,  int? completed,  int? approved, @JsonKey(name: 'applicable_for_compensatory_off')  int? applicableForCompensatoryOff,  String? status)  $default,) {final _that = this;
switch (_that) {
case _ProjectAssignmentModel():
return $default(_that.name,_that.project,_that.date,_that.taskName,_that.expectedHours,_that.spentHours,_that.description,_that.hoursDetails,_that.raisedBy,_that.completed,_that.approved,_that.applicableForCompensatoryOff,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? name,  String project,  String? date, @JsonKey(name: 'task_name')  String? taskName, @JsonKey(name: 'expected_hours')  double expectedHours, @JsonKey(name: 'spent_hours')  double spentHours,  String? description, @JsonKey(name: 'hours_details')  String? hoursDetails, @JsonKey(name: 'raised_by')  String? raisedBy,  int? completed,  int? approved, @JsonKey(name: 'applicable_for_compensatory_off')  int? applicableForCompensatoryOff,  String? status)?  $default,) {final _that = this;
switch (_that) {
case _ProjectAssignmentModel() when $default != null:
return $default(_that.name,_that.project,_that.date,_that.taskName,_that.expectedHours,_that.spentHours,_that.description,_that.hoursDetails,_that.raisedBy,_that.completed,_that.approved,_that.applicableForCompensatoryOff,_that.status);case _:
  return null;
...
class _ProjectAssignmentModel extends ProjectAssignmentModel {
  const _ProjectAssignmentModel({this.name, required this.project, this.date, @JsonKey(name: 'task_name') this.taskName, @JsonKey(name: 'expected_hours') this.expectedHours = 0.0, @JsonKey(name: 'spent_hours') this.spentHours = 0.0, this.description, @JsonKey(name: 'hours_details') this.hoursDetails, @JsonKey(name: 'raised_by') this.raisedBy, this.completed, this.approved, @JsonKey(name: 'applicable_for_compensatory_off') this.applicableForCompensatoryOff, this.status}): super._();
...
/// Create a copy of ProjectAssignmentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? project = null,Object? date = freezed,Object? taskName = freezed,Object? expectedHours = null,Object? spentHours = null,Object? description = freezed,Object? hoursDetails = freezed,Object? raisedBy = freezed,Object? completed = freezed,Object? approved = freezed,Object? applicableForCompensatoryOff = freezed,Object? status = freezed,}) {
