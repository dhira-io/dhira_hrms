...
class _TimesheetEntity extends TimesheetEntity {
  const _TimesheetEntity({required this.name, required this.employee, this.employeeName, this.hoursTotal = 0.0, this.fromDate, this.toDate, this.docStatus = 0, this.expectedHoursTotal = 0.0, this.remainingHours = 0.0, this.totalSpentHours = 0.0, this.approver, this.approverName, this.department, final  List<ProjectAssignmentEntity>? projectAssignments}): _projectAssignments = projectAssignments,super._();
  

@override final  String name;
@override final  String employee;
@override final  String? employeeName;
@override@JsonKey() final  double hoursTotal;
@override final  String? fromDate;
@override final  String? toDate;
@override@JsonKey() final  int docStatus;
@override@JsonKey() final  double expectedHoursTotal;
@override@JsonKey() final  double remainingHours;
@override@JsonKey() final  double totalSpentHours;
