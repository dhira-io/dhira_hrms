...
mixin _$TimesheetEntity {
 ...
 String get name; String get employee; String get employeeName; double get hoursTotal; String get fromDate; String get toDate; int get docStatus; double get expectedHoursTotal; double get remainingHours; double get totalSpentHours; String get approver; String get approverName; List<ProjectAssignmentEntity>? get projectAssignments;
...
@override
int get hashCode => Object.hash(runtimeType,name,employee,employeeName,hoursTotal,fromDate,toDate,docStatus,expectedHoursTotal,remainingHours,totalSpentHours,approver,approverName,const DeepCollectionEquality().hash(projectAssignments));

@override
String toString() {
  return 'TimesheetEntity(name: $name, employee: $employee, employeeName: $employeeName, hoursTotal: $hoursTotal, fromDate: $fromDate, toDate: $toDate, docStatus: $docStatus, expectedHoursTotal: $expectedHoursTotal, remainingHours: $remainingHours, totalSpentHours: $totalSpentHours, approver: $approver, approverName: $approverName, projectAssignments: $projectAssignments)';
}
...
@useResult
$Res call({
 String name, String employee, String employeeName, double hoursTotal, String fromDate, String toDate, int docStatus, double expectedHoursTotal, double remainingHours, double totalSpentHours, String approver, String approverName, List<ProjectAssignmentEntity>? projectAssignments
});
...
/// Create a copy of TimesheetEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? employee = null,Object? employeeName = null,Object? hoursTotal = null,Object? fromDate = null,Object? toDate = null,Object? docStatus = null,Object? expectedHoursTotal = null,Object? remainingHours = null,Object? totalSpentHours = null,Object? approver = null,Object? approverName = null,Object? projectAssignments = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String employee,  String employeeName,  double hoursTotal,  String fromDate,  String toDate,  int docStatus,  double expectedHoursTotal,  double remainingHours,  double totalSpentHours,  String approver,  String approverName,  List<ProjectAssignmentEntity>? projectAssignments)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TimesheetEntity() when $default != null:
return $default(_that.name,_that.employee,_that.employeeName,_that.hoursTotal,_that.fromDate,_that.toDate,_that.docStatus,_that.expectedHoursTotal,_that.remainingHours,_that.totalSpentHours,_that.approver,_that.approverName,_that.projectAssignments);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String employee,  String employeeName,  double hoursTotal,  String fromDate,  String toDate,  int docStatus,  double expectedHoursTotal,  double remainingHours,  double totalSpentHours,  String approver,  String approverName,  List<ProjectAssignmentEntity>? projectAssignments)  $default,) {final _that = this;
switch (_that) {
case _TimesheetEntity():
return $default(_that.name,_that.employee,_that.employeeName,_that.hoursTotal,_that.fromDate,_that.toDate,_that.docStatus,_that.expectedHoursTotal,_that.remainingHours,_that.totalSpentHours,_that.approver,_that.approverName,_that.projectAssignments);case _:
  throw StateError('Unexpected subclass');
...
@override
int get hashCode => Object.hash(runtimeType,name,employee,employeeName,hoursTotal,fromDate,toDate,docStatus,expectedHoursTotal,remainingHours,totalSpentHours,approver,approverName,const DeepCollectionEquality().hash(_projectAssignments));
