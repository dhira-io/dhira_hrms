...
mixin _$KpiEntity {
 ...
 String? get id; String get title; String get kra; String get description; double get weightage; double get target;
...
@override
int get hashCode => Object.hash(runtimeType,id,title,kra,description,weightage,target);
...
@useResult
$Res call({
 String? id, String title, String kra, String description, double weightage, double target
});
...
/// Create a copy of KpiEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? kra = null,Object? description = null,Object? weightage = null,Object? target = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String title,  String kra,  String description,  double weightage,  double target)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _KpiEntity() when $default != null:
return $default(_that.id,_that.title,_that.kra,_that.description,_that.weightage,_that.target);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String title,  String kra,  String description,  double weightage,  double target)  $default,) {final _that = this;
switch (_that) {
case _KpiEntity():
return $default(_that.id,_that.title,_that.kra,_that.description,_that.weightage,_that.target);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String title,  String kra,  String description,  double weightage,  double target)?  $default,) {final _that = this;
switch (_that) {
case _KpiEntity() when $default != null:
return $default(_that.id,_that.title,_that.kra,_that.description,_that.weightage,_that.target);case _:
  return null;
...
class _KpiEntity implements KpiEntity {
  const _KpiEntity({this.id, required this.title, this.kra = '', this.description = '', this.weightage = 0.0, this.target = 0.0});
...
/// Create a copy of KpiEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? title = null,Object? kra = null,Object? description = null,Object? weightage = null,Object? target = null,}) {
