...
abstract class SelfAssessmentModel with _$SelfAssessmentModel {
  ...
  static Object? _readCompetencies(Map json, String key) =>
      _readCompetenciesList(json, key);
}
...
Object? _readKra(Map json, String key) {
  return json['kra'] ?? json['kras'];
}
...
abstract class FileAttachmentModel with _$FileAttachmentModel {
  ...
  FileAttachmentEntity toEntity() =>
      FileAttachmentEntity(name: name, fileName: fileName, fileUrl: fileUrl);
}
...
abstract class GoalReviewModel with _$GoalReviewModel {
  const factory GoalReviewModel({
    ...
    @JsonKey(name: 'kras', readValue: _readKra) @Default('') String kras,
...
abstract class CompetencyReviewModel with _$CompetencyReviewModel {
  ...
  CompetencyReviewEntity toEntity() =>
      CompetencyReviewEntity(name: name, competency: competency);
}
