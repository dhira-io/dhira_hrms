...
mixin _$DashboardState {
 ...
 List<DashboardItem> get allEmployeeActions; List<DashboardItem> get allCompanyInfo; List<DashboardItem> get filteredEmployeeActions; List<DashboardItem> get filteredCompanyInfo; String get searchQuery; bool get isLoading; bool get isProfileMenuOpen; bool get isMainMenuOpen; DashboardStatsEntity? get stats; bool get statsLoading; String? get statsError;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardState&&const DeepCollectionEquality().equals(other.allEmployeeActions, allEmployeeActions)&&const DeepCollectionEquality().equals(other.allCompanyInfo, allCompanyInfo)&&const DeepCollectionEquality().equals(other.filteredEmployeeActions, filteredEmployeeActions)&&const DeepCollectionEquality().equals(other.filteredCompanyInfo, filteredCompanyInfo)&&(identical(other.searchQuery, searchQuery) || other.searchQuery == searchQuery)&&(identical(other.isLoading, isLoading) || other.isLoading == isLoading)&&(identical(other.isProfileMenuOpen, isProfileMenuOpen) || other.isProfileMenuOpen == isProfileMenuOpen)&&(identical(other.isMainMenuOpen, isMainMenuOpen) || other.isMainMenuOpen == isMainMenuOpen)&&(identical(other.stats, stats) || other.stats == stats)&&(identical(other.statsLoading, statsLoading) || other.statsLoading == statsLoading)&&(identical(other.statsError, statsError) || other.statsError == statsError));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(allEmployeeActions),const DeepCollectionEquality().hash(allCompanyInfo),const DeepCollectionEquality().hash(filteredEmployeeActions),const DeepCollectionEquality().hash(filteredCompanyInfo),searchQuery,isLoading,isProfileMenuOpen,isMainMenuOpen,stats,statsLoading,statsError);

@override
String toString() {
  return 'DashboardState(allEmployeeActions: $allEmployeeActions, allCompanyInfo: $allCompanyInfo, filteredEmployeeActions: $filteredEmployeeActions, filteredCompanyInfo: $filteredCompanyInfo, searchQuery: $searchQuery, isLoading: $isLoading, isProfileMenuOpen: $isProfileMenuOpen, isMainMenuOpen: $isMainMenuOpen, stats: $stats, statsLoading: $statsLoading, statsError: $statsError)';
}
...
@useResult
$Res call({
 List<DashboardItem> allEmployeeActions, List<DashboardItem> allCompanyInfo, List<DashboardItem> filteredEmployeeActions, List<DashboardItem> filteredCompanyInfo, String searchQuery, bool isLoading, bool isProfileMenuOpen, bool isMainMenuOpen, DashboardStatsEntity? stats, bool statsLoading, String? statsError
});
...
/// Create a copy of DashboardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? allEmployeeActions = null,Object? allCompanyInfo = null,Object? filteredEmployeeActions = null,Object? filteredCompanyInfo = null,Object? searchQuery = null,Object? isLoading = null,Object? isProfileMenuOpen = null,Object? isMainMenuOpen = null,Object? stats = freezed,Object? statsLoading = null,Object? statsError = freezed,}) {
...
as DashboardStatsEntity?,statsLoading: null == statsLoading ? _self.statsLoading : statsLoading // ignore: cast_nullable_to_non_nullable
as bool,statsError: freezed == statsError ? _self.statsError : statsError // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<DashboardItem> allEmployeeActions,  List<DashboardItem> allCompanyInfo,  List<DashboardItem> filteredEmployeeActions,  List<DashboardItem> filteredCompanyInfo,  String searchQuery,  bool isLoading,  bool isProfileMenuOpen,  bool isMainMenuOpen,  DashboardStatsEntity? stats,  bool statsLoading,  String? statsError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardState() when $default != null:
return $default(_that.allEmployeeActions,_that.allCompanyInfo,_that.filteredEmployeeActions,_that.filteredCompanyInfo,_that.searchQuery,_that.isLoading,_that.isProfileMenuOpen,_that.isMainMenuOpen,_that.stats,_that.statsLoading,_that.statsError);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_allEmployeeActions),const DeepCollectionEquality().hash(_allCompanyInfo),const DeepCollectionEquality().hash(_filteredEmployeeActions),const DeepCollectionEquality().hash(_filteredCompanyInfo),searchQuery,isLoading,isProfileMenuOpen,isMainMenuOpen,stats,statsLoading,statsError);
...
/// Create a copy of DashboardState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? allEmployeeActions = null,Object? allCompanyInfo = null,Object? filteredEmployeeActions = null,Object? filteredCompanyInfo = null,Object? searchQuery = null,Object? isLoading = null,Object? isProfileMenuOpen = null,Object? isMainMenuOpen = null,Object? stats = freezed,Object? statsLoading = null,Object? statsError = freezed,}) {
