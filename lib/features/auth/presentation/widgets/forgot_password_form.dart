        ...
        return Column(
          ...
          children: [
            ...
            if (isSuccess) ...[
              ...
              Center(child: Text(l10n.checkYourInbox, style: AppTextStyle.h3)),
              ...
              // Form State UI
              Center(child: Text(l10n.resetViaEmail, style: AppTextStyle.h3)),
              SizedBox(height: 12.h),
              Center(
                child: Text(
